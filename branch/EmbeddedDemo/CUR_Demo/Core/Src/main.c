...
/**
 * Used to detect tick transitions for the executive loop
 */
uint32_t gSystemTick;
/**
 * Track skipped ticks
 */
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED_GREEN_Pin|GPIO_PIN_0|GPIO_PIN_1, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(GPIOD, OLED_DC_Pin|OLED_RST_Pin|GPIO_PIN_6, GPIO_PIN_RESET);

  /*Configure GPIO pin Output Level */
  HAL_GPIO_WritePin(SPI_SELECT_1_GPIO_Port, SPI_SELECT_1_Pin, GPIO_PIN_SET);
  ...
  /*Configure GPIO pins : OLED_DC_Pin SPI_SELECT_1_Pin PD6 */
  GPIO_InitStruct.Pin = OLED_DC_Pin|SPI_SELECT_1_Pin|GPIO_PIN_6;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_HIGH;
